...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{asset('assets/surveyor/images/1.jpg')}}">
        <div class="form-wrapper">
            ...
            <form action="{{ route('agent.login') }}" method="POST" class="cmn-form mt-30" onsubmit="return submitUserForm();">
                @csrf
                ...
                <div class="form-group d-flex justify-content-between align-items-center mt-1">
                    ...
                    <a href="{{route('agent.register')}}" class="text-muted text--small"><i class="las la-sign-in-alt"></i> @lang('Register Now?')</a>
                </div>
                <div class="form-group">
