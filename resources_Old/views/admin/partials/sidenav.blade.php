    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                @endif
                @if(auth()->guard('admin')->user()->can('manage-ad-type'))
                <li class="sidebar-menu-item {{menuActive('admin.add-type*')}}">
                    <a href="{{route('admin.add-type')}}" class="nav-link ">
                        <i class="menu-icon las la-tags"></i>
                        <span class="menu-title">@lang('Ad Type')</span>
                    </a>
                </li>
                @endif
                <!--@if(auth()->guard('admin')->user()->can('manage-offer-type'))-->

                <!--@endif-->
                @if(auth()->guard('admin')->user()->can('manage-transactions'))
                 <li class="sidebar-menu-item {{menuActive('admin.registration*')}}">
                    <a href="{{route('admin.registration')}}" class="nav-link ">
                        <i class="menu-icon las la-tags"></i>
                        <span class="menu-title">@lang('Registration Fees')</span>
                    </a>
                </li>
                @endif
                @if(auth()->guard('admin')->user()->can('manage-settings'))
                <li class="sidebar-menu-item {{menuActive('admin.stop*')}}">
                    <a href="{{route('admin.stopresume')}}" class="nav-link ">
                        <i class="menu-icon las la-tags"></i>
                        <span class="menu-title">@lang('Stop/Resume')</span>
                    </a>
                </li>
                @endif

                <li class="sidebar-menu-item {{menuActive('admin.slider-second*')}}">
                    <a href="{{route('admin.slider-second')}}" class="nav-link ">
                        <i class="menu-icon las la-tags"></i>
                        <span class="menu-title">@lang('Slide Price')</span>
                    </a>
                </li>
             <li class="sidebar-menu-item {{menuActive('admin.offer-type*')}}">
                    <a href="{{route('admin.offer-type')}}" class="nav-link ">
                        <i class="menu-icon las la-tags"></i>
                        <span class="menu-title">@lang('Offer Type')</span>
                    </a>
                </li>
                @if(auth()->guard('admin')->user()->can('manage-transactions'))
                    <li class="sidebar-menu-item {{menuActive('admin.transactions*')}}">
                        <a href="{{route('admin.transactions')}}" class="nav-link ">
                            <i class="menu-icon las la-tags"></i>
                            <span class="menu-title">@lang('Transactions')</span>
                        </a>
                    </li>
                    <li class="sidebar-menu-item {{menuActive('admin.refunds*')}}">
                        <a href="{{route('admin.refunds')}}" class="nav-link ">
                            <i class="menu-icon las la-tags"></i>
                            <span class="menu-title">@lang('Refunds')</span>
                        </a>
                    </li>
                @endif
                ...
                @if(auth()->guard('admin')->user()->can('manage-agent'))
                <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.agent.all')}} ">
                                <a href="{{route('admin.agent.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Agent')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.agent.active')}} ">
                                <a href="{{route('admin.agent.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Agent')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.agent.banned')}} ">
                                <a href="{{route('admin.agent.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Agent')</span>
                    ...
                    <li class="sidebar-menu-item {{menuActive('admin.agent.earnings*')}}">
                        <a href="{{route('admin.agent.earnings')}}" class="nav-link ">
                            <i class="menu-icon las la-tags"></i>
                            <span class="menu-title">@lang('Agent Earnings')</span>
                        </a>
                    </li>
                @endif
                ...
                @if(auth()->guard('admin')->user()->can('manage-sponsor'))
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.surveyors*',3)}}">
                        <i class="menu-icon las la-users"></i>
                        <span class="menu-title">@lang('Manage Sponsor')</span>
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.all')}} ">
                                <a href="{{route('admin.surveyors.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Sponsor')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.active')}} ">
                                <a href="{{route('admin.surveyors.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Sponsor')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.post_arrangement.request')}} ">
                                <a href="{{route('admin.surveyors.post_arrangement.request')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('PA Request')</span>
                                    @if($pa_request_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pa_request_count}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.banned')}} ">
                                <a href="{{route('admin.surveyors.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Sponsor')</span>
                                    @if($banned_surveyors_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$banned_surveyors_count}}</span>
                                    @endif
                                </a>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.roles*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.roles.all')}} ">
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.report.surveyor.transaction','admin.report.surveyor.transaction.search'])}}">
                                <a href="{{route('admin.report.surveyor.transaction')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Sponsor Transaction')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.report.surveyor.login.history','admin.report.surveyor.login.ipHistory'])}}">
                                <a href="{{route('admin.report.surveyor.login.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Sponsor Login History')</span>
                                </a>
                            </li>
