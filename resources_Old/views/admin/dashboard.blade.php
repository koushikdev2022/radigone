...
@section('panel')
    ...
    <div class="row mb-none-30">
        ...
        <div class="col-xl-4 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-44 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Sponsor')</span>
                    </div>
        ...
        <div class="col-xl-4 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-44 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['total_agent']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Agent')</span>
                    </div>
    ...
    <div class="row mb-none-30 mt-5">
        ...
        <div class="col-xl-6 mb-30">
            <div class="card ">
                <div class="card-header">
                    <h6 class="card-title mb-0">@lang('New Sponsor list')</h6>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
