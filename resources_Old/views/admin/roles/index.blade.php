        ...
        <div class="col-lg-12">
            <div class="card b-radius--10 ">
                            ...
                            @forelse($roles as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        ...
                                        <a href="{{route('admin.roles.edit', $item->id)}}" class="icon-btn mr-1" data-toggle="tooltip" title="@lang('Questions')" data-original-title="@lang('Questions')">
                ...
                <div class="card-footer py-4">
                    {{ $roles->links('admin.partials.paginate') }}
                </div>
            </div><!-- card end -->
        </div>
    </div>
...
@push('breadcrumb-plugins')
    <div class="btn--search--area">
        <div class="item">
            <a href="{{route('admin.roles.create')}}" class="btn btn-lg btn--primary box--shadow1 text--small addBtn"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
        </div>
        <div class="item">
