                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('Offer type name')</th>
                        ...
                        <tbody class="list">
                            @forelse ($categories as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Offer type name')">{{ $item->name }}</td>
                                   
                                    <td data-label="@lang('Action')">
                                        <a href="#" class="icon-btn  updateBtn" data-route="{{ route('admin.offer-type.update',$item->id) }}" data-resourse="{{$item}}" data-toggle="modal" data-target="#updateBtn" ><i class="la la-pencil-alt"></i></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> @lang('Add Offer type')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('admin.offer-type.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label>@lang('Offer type name')</label>
                        <input type="text"class="form-control" placeholder="@lang('Enter offer type name')" name="name" required>
                    </div>
...
<div id="updateBtn" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> @lang('Update offer type')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="" class="edit-route" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>@lang('Offer type name')</label>
                        <input type="text"class="form-control name" placeholder="@lang('Enter offer type name')" name="name" required>
                    </div>
