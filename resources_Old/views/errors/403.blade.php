...
<head>
    ...
    <title>{{ $general->sitename($page_title ?? '403 | You have permission to visit this page') }}</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                ...
                <h2 class="title"><b>@lang('403')</b> @lang('You have no permission to visit this page.')</h2>
