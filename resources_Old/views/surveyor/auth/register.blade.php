                            ...
                            <form action="{{ route('surveyor.regStatus') }}" method="POST" class="cmn-form mt-30 form-row" onsubmit="return submitUserForm();">
                                ...
                                <div class="form-group col-md-6 country-code">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mobile" class="form-control b-radius--capsule" onkeypress="return /[0-9]/i.test(event.key)" maxlength="10" placeholder="@lang('Your Phone Number')">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
...
{{--                                </div>--}}
                                ...
                                <div class="form-group col-md-6">
                                    <label for="pan">@lang('Pan Card')</label>
