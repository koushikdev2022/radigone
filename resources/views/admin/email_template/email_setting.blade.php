                        ...
                        <div class="form-row mt-4 d-none configForm" id="smtp">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="enc">
                                    <option value="ssl" {{ isset($general_setting->mail_config->enc) && $general_setting->mail_config->enc == 'ssl' ? 'selected' : '' }}>@lang('SSL')</option>
                                    <option value="tls" {{ isset($general_setting->mail_config->enc) && $general_setting->mail_config->enc == 'tls' ? 'selected' : '' }}>@lang('TLS')</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
