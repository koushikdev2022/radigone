                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('After Bank Charge (MDR)')</th>
                            ...
                            @forelse($withdrawals as $withdraw)
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('After Bank Charge (MDR)')" class="budget">{{ getAmount($withdraw->after_charge) }} {{__($general->cur_text)}}</td>
