...
@section('panel')
    ...
    <div class="row mb-none-30">
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
                ...
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        ...
                        <div class="mt-15">
                          ...
                          <div class="mt-15">
                               @if(!empty($surveyor->id_proof))
                            <h4 class=""><a href ="{{url($surveyor->id_proof)}}" class="btn btn-primary" target="_blank">Pan Card Proof</a></h4>
                               @endif
                        </div>
                         <div class="mt-15">
                             @if(!empty($surveyor->address_proof))
                            <h4 class=""><a href = "{{url($surveyor->address_proof)}}" class="btn btn-primary" target="_blank">Address Proof</a></h4>
                             @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Views')</h5>
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Bought Views')
                    ...
                    <form action="{{route('admin.surveyors.update.views',[$surveyor->id])}}" method="POST" class="mt-2"
                          enctype="multipart/form-data">
                    @csrf
                        <div class="form-group ">
                            <label class="form-control-label  font-weight-bold">@lang('Add Views') <span class="text-danger">*</span></label>
                            <input class="form-control" type="number" name="add_views" min="1" required>
                        </div>
                        <button type="submit" class="btn btn--primary btn--shadow btn-block btn-lg">
                            @lang('Update')
                        </button>
                    </form>
                </div>
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Sponsor action')</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.surveyors.update',[$surveyor->id])}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            @if($surveyor->post_arrangement != \App\Surveyor::PA_INACTIVE)
                                <div class="form-group  col-md-4  col-sm-3 col-12">
                                    <label class="form-control-label font-weight-bold">@lang('Postpaid') </label>
                                    <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-warning"
                                           data-toggle="toggle" data-on="@lang('Active')" data-off="@lang('In Review')" name="post_arrangement"
                                           @if($surveyor->post_arrangement == 1) checked @endif>
                                </div>

                                <div class="form-group  col-md-4  col-sm-3 col-12">
                                    <label class="form-control-label font-weight-bold">@lang('Postpaid Mode') </label>
                                    <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                           data-toggle="toggle" data-on="@lang('Active')" data-off="@lang('Deactive')" name="post_arrangement_mode"
                                           @if($surveyor->post_arrangement_mode) checked @endif>
                                </div>

                                <div class="form-group  col-md-4  col-sm-3 col-12">
                                    <label class="form-control-label font-weight-bold">@lang('Agreement Doc') </label>
                                    <input type="file" name="post_arrangement_doc" id="imageInput" hidden>
                                    <a href="javascript:void(0)" class="btn btn--primary btn--shadow btn-block" onclick="imageFileShow()">
