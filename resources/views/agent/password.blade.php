            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        ...
                        <div class="mt-15">
                            <h4 class="">{{$agent->fullname}}</h4>
                            <span class="text--small">@lang('Joined At') <strong>{{showDateTime($agent->created_at,'d M, Y h:i A')}}</strong></span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Current Password')<span class="text-danger">*</span></label>
...
@push('breadcrumb-plugins')
    <a href="{{route('agent.profile')}}" class="btn btn-sm btn--primary box--shadow1 text--small" ><i class="fa fa-user"></i>@lang('Profile Setting')</a>
@endpush
