                            ...
                            <div class="panel-body-inner">
                                <div class="profile-thumb-area text-center">
                                    ...
                                    <div class="profile-content-area text-center mt-20">
                                        ...
                                        <h5 class="reference">@lang('Radigone Points') : <span class="badge badge--primary text-white">{{getAmount($user->balance)}}</span></h5>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-form-area">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6 form-group">
                                    <label>Pan Card Number No.</label>
                                    <input type="text" name="pan" class="form-control pan" placeholder="Enter Pan Card Number No" value="{{@$user->pan}}" {{!is_null($user->pan) ? 'readonly' : null}}>
