...
@section('panel')
   ...
   {{-- @php
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <form id="survey-form"   method="POST" enctype="multipart/form-data" data-balurl="{{route('surveyor.insufficient_balance')}}" data-url="{{route('surveyor.survey.republish', $survey->id)}}">
                    @csrf
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 for-custom-input">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="total" id="totalprice" class="form-control"  name="total"   readonly>
                                        </div>
                                    </div>
