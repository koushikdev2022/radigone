                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">@lang('Product/Service Price (₹)')</th>
                                    <th scope="col">@lang('Selling Price (₹)')</th>
                                    <th scope="col">@lang('Total Campaign Price (₹)')</th>
                                    <th scope="col">@lang('Per View Price (₹)')</th>
                                    <th scope="col">@lang('Campaign Status')</th>
                                    <th scope="col">@lang('Campaign Review')</th>
                                    <th scope="col">@lang(' Campaign wise No. of Questions')</th>
                                    <th scope="col">@lang('Total Bought Views')</th>
                                    <th scope="col">@lang('Remaining Paid Views')</th>
                                    <th scope="col">@lang('Posting Date')</th>
                                    
                                    <th scope="col"></th>
                                    <th scope="col">@lang('Payment and Submit')</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @forelse($surveys as $item)
                                    ...
                                    @endphp
                                    @php
                                            if($item->totalprice >= getAmount($surveyor->balance)) {
                                                $form_route = route('surveyor.insufficient_balance');
                                            }else {
                                                $form_route = route('surveyor.survey.save');
                                            }
...
{{--                                            </a>--}}
                                        ...
                                        <td><input type="hidden" name="dump_id" value="{{$item->id}}"></td>
                                        <td>
                                            <form method="POST" action="{{$form_route}}">
                                                @csrf
                                                <input type="hidden" name="totalSurvey" value={{getAmount($surveyor->balance)}}>
                                            <input type="hidden" name="totalprice" value="{{$item->totalprice}}">
                                            <input type="hidden" name="dump_id" value="{{$item->id}}">
...
@push('breadcrumb-plugins')
    <a href="{{route('surveyor.survey.new')}}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="fa fa-fw fa-plus"></i>@lang('Create Campaign')</a>
@endpush
