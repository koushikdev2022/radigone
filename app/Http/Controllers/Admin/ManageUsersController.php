...
class ManageUsersController extends Controller
{
    public function allUsers()
    {
        ...
        $count = User::count();
        return view('admin.users.list', compact('page_title', 'empty_message', 'users','count'));
    }
    ...
    public function emailUnverifiedUsers()
    {
        ...
        $count = User::emailUnverified()->count();;
        return view('admin.users.list', compact('page_title', 'empty_message', 'users','count'));
    }
    public function emailVerifiedUsers()
    {
        ...
        $count = User::emailVerified()->count();;
        return view('admin.users.list', compact('page_title', 'empty_message', 'users','count'));
    }
    ...
    public function smsUnverifiedUsers()
    {
        ...
        $count = User::smsUnverified()->count();;
        return view('admin.users.list', compact('page_title', 'empty_message', 'users','count'));
    }
